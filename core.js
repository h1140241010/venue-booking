...
var VenueCore = (function () {
  ...
  var units = ['工程學院', '管理學院', '人設學院', '機械工程系', '半導體工程系', '電機工程系', '電子工程系', '資訊網路工程系', '企業管理系', '資訊管理系', '數位行銷暨跨境商務系', '財務金融系', '工業管理系', '應用外語系', '多媒體與遊戲發展科學系', '觀光休閒系', '文化創意與數位媒體設計系', '教務處', '學務處', '總務處', '招生處', '國合處', '研發處', '秘書室', '人事室', '環安室'];
  var roomInfo = {
